...
const renderButton=(inactive,merchanthandle,promoname,promobuttontext)=>{
  if (inactive=='true'){
  return (
    <div className='igpromoLeft_linkholder'>
...
const MiniPromoItem = (props) => (


  <>
  <div className='minipromoHolder' style={{backgroundColor: '#'+props.promobackgroundcolor}}>
    <div className='minipromoLeft' style={{backgroundColor: '#'+props.promobackgroundcolor}}>
      <div className='title' style={{color:'#'+props.promotitlecolor}}>
      {props.promotitle}  
      </div>
      <div className='subtitle' style={{color:'#'+props.messagecolor}}>
      {props.promomessage} 
      </div>
      {renderButton(props.disable,props.merchanthandle,props.promoname,props.promobuttontext)}
    </div>
    <div className='minipromoRight'>
    <img className="promoimage" src={imgSelector(props.promoimageheader )} />
    </div>
  </div>
...
MiniPromoItem.propTypes = {};

export default MiniPromoItem;
